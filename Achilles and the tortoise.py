...
def chase(a1_speed, t2_speed, advantage):
	# Think about movement equations and then find the intersection
	# x1 = x0 + v1*t
	# x2 = x0 + v2*t
	# x1 = x2, x0 = advantage(seconds)*speed
	# t = advantage*t2_speed/(a1_speed - t2_speed)
    return advantage + (advantage*t2_speed/(a1_speed - t2_speed))
